...
<ul>
    <li>
        <span style="color:black"><strong>Haoxiang Qin</strong></strong></span>. Blocking hybrid flow shop scheduling problems based on iterative greedy algorithms. <span style="color:#b6321c" id="TEVC"><em><strong>Liaocheng University</strong></em></span> <a href="/pdf/Master_Thesis.pdf">[PDF]</a>.
    </li>
</ul>
